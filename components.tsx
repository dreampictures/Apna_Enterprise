        ...
        <>
          ...
          <div className="mt-8 border-t border-slate-100 pt-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                <Button variant="ghost" size="sm" onClick={() => { setItems([]); onDirty(false); }} className="text-slate-500 hover:text-red-600 h-8 text-xs font-semibold bg-slate-50">
                  <Trash2 className="w-3.5 h-3.5 mr-1.5" /> {c.clear}
                </Button>
        ...
        <div className="mt-10 border-t border-slate-100 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <Button variant="ghost" size="sm" onClick={() => { setItems([]); onDirty(false); }} className="flex-1 sm:flex-none text-red-500 hover:text-red-600 hover:bg-red-50 h-8 text-xs font-bold bg-red-50/50">
                <Trash2 className="w-3.5 h-3.5 mr-1.5" /> {c.clear}
              </Button>
            ...
            {items.map((item, index) => (
              <div key={item.id} className="pdf-tools-file-row">
                ...
                <div className="pdf-tools-file-name flex flex-col justify-center gap-0.5 ml-2">
                  <span className="font-bold text-[13px]">{item.file.name}</span>
                  <span className="text-[11px] text-slate-500 font-medium">1024 x 1365 | {bytesLabel(item.file.size)}</span>
                </div>
          ...
          <div className="border-t border-slate-100 pt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <div className="flex gap-2">
                  <button className="flex-1 py-2 px-3 bg-white border-2 border-yellow-400 rounded-lg text-xs font-bold text-slate-800 flex items-center justify-center gap-2">
                    <File className="w-3.5 h-3.5" /> Portrait
                  </button>
                  <button className="flex-1 py-2 px-3 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-500 flex items-center justify-center gap-2 hover:bg-slate-50">
                    <File className="w-3.5 h-3.5 rotate-90" /> Landscape
                  </button>
                </div>
              </div>
            </div>
        ...
        <div className="mt-10 border-t border-slate-100 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <Button variant="ghost" size="sm" onClick={() => { setPages([]); onDirty(false); }} className="text-red-500 hover:text-red-600 hover:bg-red-50 h-9 text-xs font-bold bg-red-50/50 flex-1 md:flex-none">
                <Trash2 className="w-3.5 h-3.5 mr-1.5" /> {c.clear}
              </Button>
